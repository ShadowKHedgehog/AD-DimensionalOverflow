...
export default {
  ...
  methods: {
    update() {
      this.visible = GameEnd2.endState >= END_STATE_MARKERS.SHOW_NEW_GAME && !GameEnd.removeAdditionalEnd;
      this.opacity = (GameEnd2.endState - END_STATE_MARKERS.SHOW_NEW_GAME) * 2;
